...
-v $(pwd)/README.md:/usr/src/app/README.md \
-v $(pwd)/apollo:/usr/src/app/apollo \
-v $(pwd)/handler.js:/usr/src/app/handler.js \
-v $(pwd)/nuxt.config.js:/usr/src/app/nuxt.config.js \
-v $(pwd)/serverless.yml:/usr/src/app/serverless.yml \
